...
$seanses = $seansClass->getAll('*', true, 'seans_date', 'alias = ? AND seans_date > ?', array('na_beregu_vol', date('Y-m-d H:i:s')));
...
<!--							<div align="right" style="width:363px; padding-top:5px;">
					...
					<div class="nb-collumn-2">
						<p><font class="sub-title" >Стоимость билета:</font> <span style="color:#000;">650 рублей.</span></p>
						<br /> 
