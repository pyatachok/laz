...
//					$('.selectee', this.context).focus();
	...
	// make it so that no error is thrown if bgIframe plugin isn't include_onced (allows you to use conditional
	// comments to only include_once bgIframe where it is needed in IE without breaking this plugin).
