				...
				<div align="left" style="width: 875px; position: relative; bottom: 3px; margin-left: 70px;">
					...
					<div style="width: 300px; float: right; background-repeat: no-repeat; background-image: url(img/elki_dati.png);">
						<div style="margin: 5px 0px 0px 45px;">
							<span class="text2"><h2>23 / 29 / 30 декабря<br>
							<span style="margin-left: 25px;">2 – 4 января</h2></span></span>
						</div>	
						<div style="width: 280px; text-align: right; position: relative; left: 140px; top: 20px; margin-top: 580px;">
							<div style="padding: 40px 35px 60px 60px; background-image:  url(img/elki_price.png) ; background-repeat: no-repeat;">
							<h2 style="color: #780603;">Стоимость:</h2>
							<font style="font-size: 20px; font-weight: lighter;"><span class="text2">650 руб.</span> – Билет<br>
					...
					<div style="width: 182px; height: 75px; clear: left; position: relative; bottom: 65px; left: 255px;">
						<a href="zakaz_elki.php">
							<img src="img/elki_button.png">
						</a>
					</div>
				</div>
			</div>
