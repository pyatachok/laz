...
$sub = "Заказ билетов с сайта Live Animation Каникулы Бонифация";
$mes = "Человек по имени: $fio \n 
Желает заказать билет(ы) на Каникулы Бонифация \n 
...
$mes2 = "Добрый день! \n
Вы заказали билеты на Каникулы Бонифация. В ближайшее время наши специалисты свяжутся с вами. \n
